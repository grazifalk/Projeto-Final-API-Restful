...
public class ConversorDeData {
	...
	/*
	 * dd => Dia do mes DD => Dia do ano MM =>> Mês mm =>> Minuto YYYY => Ano
	 * formato 2022 YY => Ano formato 22 HH => Hora formato 24hs (0 a 23) pm hh =>
	 * formato 12hs (0 a 12:00) am ss => segundos
	 * 
	 */
